...
private:
    static void pmcr(Reg64 reg) {}
    static Reg64 pmcr() {return 0;}

    static void pmcntenset(Reg64 reg) {}
    static Reg64 pmcntenset() {return 0;}

    static void pmcntenclr(Reg64 reg) {}
    static Reg64 pmcntenclr() {return 0;}

    static void pmovsr(Reg64 reg) {}
    static Reg64 pmovsr() {return 0;}

    static void pmselr(Reg64 reg) {}
    static Reg64 pmselr() {return 0;}

    static void pmxevtyper(const Reg64 reg) {}
    static Reg64 pmxevtyper() {return 0;}

    static void pmxevcntr(Reg64 reg) {}
    static Reg64 pmxevcntr() {return 0;}
