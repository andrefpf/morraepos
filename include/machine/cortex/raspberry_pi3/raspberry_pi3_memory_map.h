...
struct Memory_Map: public Cortex_Memory_Map
{
    enum : unsigned int {
        ...
        SYS_DATA        = Traits<System>::multitask ? SYS + 0x00560000 : NOT_USED,
        SYS_STACK       = Traits<System>::multitask ? SYS + 0x00700000 : NOT_USED, // 16KB mem == STACK_SIZE
        SYS_HEAP        = Traits<System>::multitask ? SYS + 0x00800000 : NOT_USED
    };
};
